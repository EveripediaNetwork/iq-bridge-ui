export const HiIQRewardsAbi = [
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint256", name: "eligible_hiiq_bal", type: "uint256" },
      {
        internalType: "uint256",
  ...
  },
  {
    inputs: [
      {
        internalType: "uint256",
        name: "_min_lock_time_for_yield",
        type: "uint256"
      }
    ],
    name: "setMinLockTimeForYield",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function"
  },
