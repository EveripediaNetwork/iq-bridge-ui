...
export const resources = {
  ...
  ko: {
    translation: {
      ...
      total: "합계",
      apps: "앱",
      prediqt_markets: "프레딕트 마켓 개수",
      everipedia_articles: "에브리피디아 위키 개수",
      everipedia_onchain_edits: "에브리피디아 온체인 편집 횟수",
      everipedia_page_views: "에브리피디아 페이지뷰",
      social: "소셜",
      // lock page
  ...
  zh: {
    translation: {
      ...
      everipedia_page_views: "Everipedia 页面阅读量",
      social: "社交媒体",
      // Lock page
